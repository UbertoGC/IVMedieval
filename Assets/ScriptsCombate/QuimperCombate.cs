...
public class QuimperCombate : MonoBehaviour
{
    ...
    [SerializeField] private AudioSource RecibirDaño;
    ...
    [SerializeField] private IniciarCombate InformacionCombate;
    ...
    {
        SonidoMuerte.Play();
        InformacionCombate.FinCombate();
        InformacionJugador.JefeDerrotado();
